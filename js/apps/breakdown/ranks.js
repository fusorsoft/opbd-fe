angular.module('csgoData').factory('Ranks', function rankDataFactory() {

	var RankInfo =  function(rank, rankName, rankSmallImg, rankImg, rankAbbr) {
		var self = this;

		self.Rank = rank;
		self.Name = rankName;
		self.SmallImg = rankSmallImg;
		self.Img = rankImg;
		self.Abbreviation = rankAbbr;
	};

	var getRankData = function(rank) {
		var rankInfo = null;
