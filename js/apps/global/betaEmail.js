var emailApp = angular.module('breakdownBetaEmailApp', ['toaster'])

emailApp.controller('emailAppController', ['$http', '$scope', '$interval', 'toaster', function ($http, $scope, $interval, toaster) {
  $scope.email = ''
