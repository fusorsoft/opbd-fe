...
var accountController = accountApp.controller('accountController', function($scope) {
	...
	var passwordValid = function() {
		...
		return (passwordAndConfirmSame && passwordLongEnough) || $scope.password.length === 0;
	};
	...
	var emailValid = function() {
		...
		return (hasAtAndDot && hasDotAfterAt && hasOneAt && hasCharacterAfterDot) || $scope.email.length === 0;
	};
